					...
					function (err, data) {
						if (!err){
							...
							var pixleeUploadBody 	= {
								  ...
								  "email": 			_this._makeSlackUploadsEmail(_this._getUserName(message, _this)),
...
PixleeBot.prototype._makeSlackUploadsEmail = function(message, context){
	// var theEmail = username + "-slackuploads@pixleeteam.com";
	// Let us try getting the person
	console.log(this)
	var theUser 	=	context.getUserById(message.user);
	console.log(theUser);
